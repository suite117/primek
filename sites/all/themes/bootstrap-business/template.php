...
function bootstrap_business_form_alter(&$form, &$form_state, $form_id) {
    ...
    $item = array();
    $items[] = l(t('Create new business account'), 'business/register', array('attributes' => array('title' => t('Sign up as company.'))));
    $items[] = l(t('Create new personal account'), 'private/register', array('attributes' => array('title' => t('Sign up as private.'))));
    $items[] = l(t('Forgotten Password?'), 'user/password', array('attributes' => array('title' => t('If you forgot your password, click to request a new password via e-mail.'))));
...
function bootstrap_business_theme() {
  ...
  'render element' => 'form',
  'path' => drupal_get_path('theme', 'bootstrap_business') . '/templates',
  'template' => 'user-login',
  'preprocess functions' => array(
  'bootstrap_business_preprocess_user_login'
  ),
);
return $items;
}
