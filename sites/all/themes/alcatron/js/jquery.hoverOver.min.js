...
(function(b) {
	...
	a.prototype = {
		...
		appendTemplate : function() {
			...
			var l = b(".hover-content-box", n.$el), h = b(".push-content-box", n.$el);
			var d = parseInt(l.css("marginLeft"), 10) + parseInt(l.css("marginRight"), 10) + parseInt(l.css("paddingLeft"), 10) + parseInt(l.css("paddingRight"), 10) + parseInt(l.css("borderLeftWidth"), 10) + parseInt(l.css("borderRightWidth"), 10), k = parseInt(l.css("marginTop"), 10) + parseInt(l.css("marginBottom"), 10) + parseInt(l.css("paddingTop"), 10) + parseInt(l.css("paddingBottom"), 10) + parseInt(l.css("borderTopWidth"), 10) + parseInt(l.css("borderBottomWidth"), 10);
			var r = n.$el.outerHeight(true) - k, o = n.$el.outerWidth(true) - d, c = b(".hover-content-box, .hover-content-copy-txt, .hover-content-box-overlay", n.$el), u = b(".hover-content-box", n.$el), i = b(".hover-content-copy-txt", n.$el), m = b(".hover-content-box-overlay", n.$el), s = b(".hover-content-copy-txt, .hover-content-box-overlay", n.$el), g = b(".hover-content-box-overlay", n.$el).css("opacity"), e = n.options.aniDurationIn, p = n.options.aniDurationOut;
